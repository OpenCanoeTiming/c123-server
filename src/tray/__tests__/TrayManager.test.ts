...
describe('TrayManager', () => {
  ...
  describe('dashboard URL uses port', () => {
    it('builds localhost URL from port config', async () => {
      const customTray = new TrayManager({ port: 28000, onQuit });
      await customTray.start();
